...
const PACKAGES = [
  "@zethrise/cli",
  "@zethrise/zethcode-darwin-arm64",
  "@zethrise/zethcode-darwin-x64",
  "@zethrise/zethcode-darwin-x64-baseline",
  "@zethrise/zethcode-linux-arm64",
  "@zethrise/zethcode-linux-arm64-musl",
  "@zethrise/zethcode-linux-x64",
  "@zethrise/zethcode-linux-x64-baseline",
  "@zethrise/zethcode-linux-x64-musl",
  "@zethrise/zethcode-linux-x64-baseline-musl",
  "@zethrise/zethcode-windows-arm64",
  "@zethrise/zethcode-windows-x64",
  "@zethrise/zethcode-windows-x64-baseline",
]
...
async function syncNpmmirror(packageName: string) {
  ...
  const res = await fetch(url, {
    ...
    body: JSON.stringify({ skipDependencies: true, tips: "ZethCode release sync" }),
  })
  if (!res.ok) {
...
console.log("═══ ZethCode Registry Sync ═══")
