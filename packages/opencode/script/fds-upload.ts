...
//   MIMO_FDS_BUCKET / MIMO_FDS_PREFIX    object layout (default zethcode/zethcode)
//
...
export const FDS_BUCKET = process.env.MIMO_FDS_BUCKET || "zethcode"
export const FDS_PREFIX = process.env.MIMO_FDS_PREFIX || "zethcode"
...
// Full object name under the bucket, e.g. "zethcode/releases/latest".
