...
- **Project**: `.zethcode/zethcode.json` (or `.jsonc`)
- **Global**: `~/.config/zethcode/zethcode.json`
...
2. Read the existing `.zethcode/zethcode.json` (project) or global config if present — don't clobber it.
