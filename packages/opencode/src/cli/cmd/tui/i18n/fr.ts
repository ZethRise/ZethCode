...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant Zeth Code, vous acceptez nos ",
  ...
  "tui.tips.config_files":
    "Créez {highlight}zethcode.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/zethcode/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "Zeth Code gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.zethcode/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.zethcode/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "Zeth Code formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "Zeth Code utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.zethcode/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.zethcode/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher Zeth Code de lire des fichiers sensibles",
  ...
  "tui.tips.serve": "Exécutez {highlight}mimo serve{/highlight} pour exposer l'API Zeth Code en mode headless",
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.zethcode/themes/{/highlight}",
  ...
  "tui.tips.zen":
    "Utilisez {highlight}/connect{/highlight} avec Zeth Code pour des modèles testés et sélectionnés",
  "tui.tips.agents_md":
  ...
  "tui.skill.zethcode.description": "Documentation intégrée des fonctionnalités, config et commandes Zeth Code",
  ...
  "tui.toast.update_available.success": "Mis à jour vers Zeth Code v{{version}}. Veuillez redémarrer l'application.",
  ...
  "trust.capabilities": "Zeth Code pourra lire, modifier et exécuter des fichiers ici.",
