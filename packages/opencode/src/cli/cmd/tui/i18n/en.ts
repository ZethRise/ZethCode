export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using Zeth Code, you agree to our ",
  ...
  "tui.tips.config_files":
    "Create {highlight}zethcode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/zethcode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "Zeth Code auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.zethcode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.zethcode/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "Zeth Code auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Zeth Code uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.zethcode/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.zethcode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Zeth Code from reading sensitive files",
  ...
  "tui.tips.serve": "Run {highlight}mimo serve{/highlight} for headless API access to Zeth Code",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.zethcode/themes/{/highlight} directory",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Zeth Code for curated, tested models",
  ...
  "tui.skill.zethcode.description": "Self-documentation for Zeth Code features, config, and commands",
  ...
  "tui.toast.update_available.success": "Successfully updated to Zeth Code v{{version}}. Please restart the application.",
  ...
  "trust.capabilities": "Zeth Code will be able to read, edit, and execute files here.",
  ...
  "skip_permissions.body":
    "You started with --dangerously-skip-permissions. Zeth Code will read, edit, and execute files and run shell commands WITHOUT asking for approval. Only rules you have explicitly denied in config are still enforced. You are solely responsible for anything it does.",
