...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar Zeth Code, aceptas nuestros ",
  ...
  "tui.tips.config_files":
    "Crea {highlight}zethcode.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/zethcode/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "Zeth Code gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.zethcode/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.zethcode/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "Zeth Code formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "Zeth Code usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.zethcode/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.zethcode/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a Zeth Code leer archivos sensibles",
  "tui.tips.run":
  ...
  "tui.tips.serve":
    "Ejecuta {highlight}mimo serve{/highlight} para acceso headless a la API de Zeth Code",
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.zethcode/themes/{/highlight}",
  ...
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con Zeth Code para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.skill.zethcode.description": "Autodocumentación de funciones, configuración y comandos de Zeth Code",
  ...
  "tui.toast.update_available.success": "Se actualizó a Zeth Code v{{version}}. Por favor reinicie la aplicación.",
  ...
  "trust.capabilities": "Zeth Code podrá leer, editar y ejecutar archivos aquí.",
