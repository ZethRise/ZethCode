...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Используя Zeth Code, вы соглашаетесь с нашими ",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}zethcode.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/zethcode/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "Zeth Code автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.zethcode/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.custom_agent":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.zethcode/agent/{/highlight} для специализированных AI-персон",
  ...
  "tui.tips.formatter":
    "Zeth Code автоматически форматирует файлы с помощью prettier, gofmt, ruff и других инструментов",
  ...
  "tui.tips.lsp": "Zeth Code использует LSP-серверы для интеллектуального анализа кода",
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.zethcode/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.zethcode/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.plugin_protect":
    "Создайте плагин, который запретит Zeth Code читать чувствительные файлы",
  "tui.tips.run":
  ...
  "tui.tips.serve":
    "Запустите {highlight}mimo serve{/highlight} для headless-доступа к API Zeth Code",
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.zethcode/themes/{/highlight}",
  ...
  "tui.tips.zen":
    "Используйте {highlight}/connect{/highlight} с Zeth Code для подобранных и протестированных моделей",
  "tui.tips.agents_md":
  ...
  "tui.skill.zethcode.description": "Самодокументация функций, конфигурации и команд Zeth Code",
  ...
  "tui.toast.update_available.success": "Обновлено до Zeth Code v{{version}}. Пожалуйста, перезапустите приложение.",
  ...
  "trust.capabilities": "Zeth Code сможет читать, редактировать и выполнять файлы здесь.",
  ...
  "skip_permissions.body":
    "Вы запустили с --dangerously-skip-permissions. Zeth Code будет читать, редактировать и выполнять файлы, а также запускать команды оболочки БЕЗ запроса подтверждения. Действуют только правила, которые вы явно запретили (deny) в конфигурации. Вы несёте полную ответственность за все его действия.",
