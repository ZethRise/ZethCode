...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 Zeth Code 即表示你同意我們的",
  ...
  "tui.tips.config_files":
    "建立 {highlight}zethcode.json{/highlight} 用於伺服器端設定，{highlight}tui.json{/highlight} 用於 TUI 設定",
  "tui.tips.global_config": "把 TUI 設定放在 {highlight}~/.config/zethcode/tui.json{/highlight} 作為全域設定",
  ...
  "tui.tips.mcp_oauth": "Zeth Code 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.zethcode/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.zethcode/agent/{/highlight} 加入 {highlight}.md{/highlight} 檔案來建立專用 AI 角色",
  ...
  "tui.tips.formatter": "Zeth Code 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "Zeth Code 使用 LSP 伺服器進行智慧程式碼分析",
  "tui.tips.custom_tool":
    "在 {highlight}.zethcode/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins":
    "在 {highlight}.zethcode/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  "tui.tips.plugin_notify": "用外掛在工作階段完成時傳送系統通知",
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 Zeth Code 讀取敏感檔案",
  ...
  "tui.tips.serve": "執行 {highlight}mimo serve{/highlight} 以無介面模式提供 Zeth Code API",
  ...
  "tui.tips.theme_files": "在 {highlight}.zethcode/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.tips.zen": "搭配 Zeth Code 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
  ...
  "tui.skill.zethcode.description": "Zeth Code 功能、設定與命令的自文件參考",
  ...
  "tui.toast.update_available.success": "已更新到 Zeth Code v{{version}}，請重新啟動應用程式。",
  ...
  "trust.capabilities": "Zeth Code 將能夠讀取、編輯和執行此目錄中的檔案。",
