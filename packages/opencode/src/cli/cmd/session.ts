...
function pagerCmd(): string[] {
  ...
  if (Flag.ZETHCODE_GIT_BASH_PATH) {
    const less = path.join(Flag.ZETHCODE_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into zethcode",
  builder: (yargs: Argv) =>
    yargs.option("force", {
