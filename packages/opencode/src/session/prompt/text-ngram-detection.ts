...
export function createTextNgramMonitor() {
  return new TextNgramMonitor(
    Flag.ZETHCODE_TEXT_NGRAM_N,
    Flag.ZETHCODE_TEXT_REPEAT_THRESHOLD,
    Flag.ZETHCODE_TEXT_WINDOW_TOKENS,
  )
}
...
REPETITION DETECTED: Your recent output contains repeated phrases (sliding n-gram match within your last ${Flag.ZETHCODE_TEXT_WINDOW_TOKENS} tokens).
