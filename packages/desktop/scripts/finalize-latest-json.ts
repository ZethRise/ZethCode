...
const releaseId = process.env.ZETHCODE_RELEASE
if (!releaseId) throw new Error("ZETHCODE_RELEASE is required")

const version = process.env.ZETHCODE_VERSION
if (!version) throw new Error("ZETHCODE_VERSION is required")
