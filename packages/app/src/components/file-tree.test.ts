...
beforeAll(async () => {
  ...
  mock.module("@zethrise/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@zethrise/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@zethrise/ui/icon", () => ({ Icon: () => null }))
  mock.module("@zethrise/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
